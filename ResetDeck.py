class ResetDeck:
  ...
  for j in range(0,3): # Runs through all the suites and creates an entrance for each
    for i in range(0,12): # Runs through all the values of the cards inside each of the suites to create a card with all values for each suite
      if i<12:
